			...
			<tbody>
				<?php foreach ( $attributes as $attribute_name => $options ) : ?>
					<tr class="table-label-row">
						<td class="label"><label for="<?php echo esc_attr( sanitize_title( $attribute_name ) ); ?>"><?php echo wc_attribute_label( $attribute_name ); // WPCS: XSS ok. ?>:&nbsp;</label><span class="selected-value">value</span></td>
					</tr>
                    <tr>
                        <td class="value">
                            <?php
